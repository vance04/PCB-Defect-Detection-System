...
/*产品ID*/
#define PROID		"d8IdNXtA66"

//鉴权Token
#define TOKEN	"version=2018-10-31&res=products%2Fd8IdNXtA66%2Fdevices%2FTest1&et=1807692100&method=md5&sign=3sN2s0%2FSWz2ZJuuiPnhi1A%3D%3D"
...
void OneNet_RevPro(unsigned char *cmd)
{
	...
	short result = 0;
	cJSON *json, *params_json, *led_json,*Alarm_json,*motor_json;
	char *dataPtr = NULL;
	char numBuf[10];
	int num = 0;
